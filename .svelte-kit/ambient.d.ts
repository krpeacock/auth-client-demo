...
declare module '$env/static/private' {
	...
	export const CANISTER_CANDID_PATH_whoami: string;
	export const CANISTER_CANDID_PATH_WHOAMI: string;
	export const WHOAMI_CANISTER_ID: string;
	export const CANISTER_ID_WHOAMI: string;
	export const CANISTER_ID_whoami: string;
	export const INTERNET_IDENTITY_CANISTER_ID: string;
	export const CANISTER_ID_INTERNET_IDENTITY: string;
	export const CANISTER_ID_internet_identity: string;
	export const AUTH_CLIENT_DEMO_ASSETS_CANISTER_ID: string;
	export const CANISTER_ID_AUTH_CLIENT_DEMO_ASSETS: string;
	export const CANISTER_ID_auth_client_demo_assets: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		DFX_VERSION: string;
		DFX_NETWORK: string;
		CANISTER_CANDID_PATH_whoami: string;
		CANISTER_CANDID_PATH_WHOAMI: string;
		WHOAMI_CANISTER_ID: string;
		CANISTER_ID_WHOAMI: string;
		CANISTER_ID_whoami: string;
		INTERNET_IDENTITY_CANISTER_ID: string;
		CANISTER_ID_INTERNET_IDENTITY: string;
		CANISTER_ID_internet_identity: string;
		AUTH_CLIENT_DEMO_ASSETS_CANISTER_ID: string;
		CANISTER_ID_AUTH_CLIENT_DEMO_ASSETS: string;
		CANISTER_ID_auth_client_demo_assets: string;
		CANISTER_ID: string;
